...
| ---- | ------------ | ------ | --------- |
| 27 февраля 2025 | Хакатон «Цифровая Россия» в г. Челябинске | **WhoCame** — продвинутая система отслеживания посещаемости на основе идентификации посетителей по лицам | ??? |
