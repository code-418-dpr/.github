...
| ---- | ------------ | ------ | --------- |
| 14 — 15 марта 2025 | Межрегиональный IT Хакатон в рамках федерального проекта «Цифровая Россия» | [**SPA AI**](https://github.com/code-418-dpr/WhoCame) — система автоматического анализа изображений: обнаружение объектов и распознавание текста | ??? |
